...
public class SocketCalculatorServer {
    ...
    private void handleClient(Socket socket) {
        String clientInfo = socket.getRemoteSocketAddress() != null ?
                socket.getRemoteSocketAddress().toString() : socket.toString();
        ...
        try (
            ...
            try {
                ...
                if (req == null || !req.has("id") || !req.has("expr")) {
                    ...
                    respJson.add("error", JsonNull.INSTANCE);
            ...
            // garante fechamento do socket (caso não tenha sido fechado pelos try-with-resources acima)
